...
public class _BaseUtilReflect {

    protected final Class<?> type;

    protected final Object object;

    protected _BaseUtilReflect(final Class<?> type) {
        this(type, type);
    }

    protected _BaseUtilReflect(final Class<?> type, Object object) {
        this.type = type;
        this.object = object;
    }
     ...
     * @return the single {@link _BaseUtilReflect} instance
     * @throws ReflectException if reflect unsuccessfully
     */
    public static _BaseUtilReflect reflect(final String className)
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static _BaseUtilReflect reflect(final String className, final ClassLoader classLoader)
            throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static _BaseUtilReflect reflect(final Class<?> clazz)
            throws ReflectException {
        return new _BaseUtilReflect(clazz);
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static _BaseUtilReflect reflect(final Object object)
            throws ReflectException {
        return new _BaseUtilReflect(object == null ? Object.class : object.getClass(), object);
    }
     ...
     * @return the single {@link _BaseUtilReflect} instance
     */
    public _BaseUtilReflect newInstance() {
     ...
     * @return the single {@link _BaseUtilReflect} instance
     */
    public _BaseUtilReflect newInstance(Object... args) {
    ...
    private _BaseUtilReflect newInstance(final Constructor<?> constructor, final Object... args) {
        try {
            return new _BaseUtilReflect(
     ...
     * @return the single {@link _BaseUtilReflect} instance
     */
    public _BaseUtilReflect field(final String name) {
        try {
            Field field = getField(name);
            return new _BaseUtilReflect(field.getType(), field.get(object));
     ...
     * @return the single {@link _BaseUtilReflect} instance
     */
    public _BaseUtilReflect field(String name, Object value) {
        try {
            Field field = getField(name);
    ...
    private Object unwrap(Object object) {
        if (object instanceof _BaseUtilReflect) {
            return ((_BaseUtilReflect) object).get();
        }
        return object;
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public _BaseUtilReflect method(final String name) throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public _BaseUtilReflect method(final String name, final Object... args) throws ReflectException {
        Class<?>[] types = getArgsType(args);
        try {
    ...
    private _BaseUtilReflect method(final Method method, final Object obj, final Object... args) {
        try {
            accessible(method);
    ...
    public boolean equals(Object obj) {
        return obj instanceof _BaseUtilReflect && object.equals(((_BaseUtilReflect) obj).get());
    }
