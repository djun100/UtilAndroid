 ...
 * <li>{@link UtilShell#checkRootPermission()}</li>
 * </ul>
 * <ul>
 * <strong>Execte command</strong>
 * <li>{@link UtilShell#execCommand(String, boolean)}</li>
 * <li>{@link UtilShell#execCommand(String, boolean, boolean)}</li>
 * <li>{@link UtilShell#execCommand(List, boolean)}</li>
 * <li>{@link UtilShell#execCommand(List, boolean, boolean)}</li>
 * <li>{@link UtilShell#execCommand(String[], boolean)}</li>
 * <li>{@link UtilShell#execCommand(String[], boolean, boolean)}</li>
 * </ul>
 * @author cy
...
public class UtilShell {
     ...
     * @return
     * @see UtilShell#execCommand(String[], boolean, boolean)
     */
