...
public final class UtilReflect {
    ...
    private UtilReflect(final Class<?> type) {
        this(type, type);
    }

    private UtilReflect(final Class<?> type, Object object) {
        this.type = type;
        this.object = object;
    }
     ...
     * @return the single {@link UtilReflect} instance
     * @throws ReflectException if reflect unsuccessfully
     */
    public static UtilReflect reflect(final String className)
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static UtilReflect reflect(final String className, final ClassLoader classLoader)
            throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static UtilReflect reflect(final Class<?> clazz)
            throws ReflectException {
        return new UtilReflect(clazz);
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static UtilReflect reflect(final Object object)
            throws ReflectException {
        return new UtilReflect(object == null ? Object.class : object.getClass(), object);
    }
     ...
     * @return the single {@link UtilReflect} instance
     */
    public UtilReflect newInstance() {
     ...
     * @return the single {@link UtilReflect} instance
     */
    public UtilReflect newInstance(Object... args) {
    ...
    private UtilReflect newInstance(final Constructor<?> constructor, final Object... args) {
        try {
            return new UtilReflect(
     ...
     * @return the single {@link UtilReflect} instance
     */
    public UtilReflect field(final String name) {
        try {
            Field field = getField(name);
            return new UtilReflect(field.getType(), field.get(object));
     ...
     * @return the single {@link UtilReflect} instance
     */
    public UtilReflect field(String name, Object value) {
        try {
            Field field = getField(name);
    ...
    private Object unwrap(Object object) {
        if (object instanceof UtilReflect) {
            return ((UtilReflect) object).get();
        }
        return object;
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public UtilReflect method(final String name) throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public UtilReflect method(final String name, final Object... args) throws ReflectException {
        Class<?>[] types = getArgsType(args);
        try {
    ...
    private UtilReflect method(final Method method, final Object obj, final Object... args) {
        try {
            accessible(method);
    ...
    public boolean equals(Object obj) {
        return obj instanceof UtilReflect && object.equals(((UtilReflect) obj).get());
    }
