...
public class CircleWithBorderTransform extends BitmapTransformation {
    ...
    public CircleWithBorderTransform(float borderWidth, int borderColor) {
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) {
        messageDigest.update((ID + borderWidth * 10).getBytes(CHARSET));
    }

    @Override
    public boolean equals(Object o) {
        return o instanceof CircleWithBorderTransform;
    }
